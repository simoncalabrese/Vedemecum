...
CREATE TABLE `MANSIONI` (
  `ID_MANSIONE` int(11) NOT NULL AUTO_INCREMENT,
  `COD_MANSIONE` varchar(10) NOT NULL,
  `DES_MANSIONE` varchar(45) NOT NULL,
  PRIMARY KEY (`ID_MANSIONE`),
  UNIQUE KEY `COD_MANSIONE_UNIQUE` (`COD_MANSIONE`),
  UNIQUE KEY `DES_MANSIONE_UNIQUE` (`DES_MANSIONE`)
...
INSERT INTO `MANSIONI` VALUES (9,'AMM','AMMINISTRATORE');
